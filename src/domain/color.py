...
class Color(Enum):
    ...
    BLACK = ((0, 0, 0), np.array([0, 0, 0]), np.array([180, 255, 50]))
    ...
    TARGET_ZONE_GREEN = ((0, 254, 0), np.array([40, 40, 80]), np.array([76, 255, 255]))
    WHITE = ((255, 255, 255), np.array([30, 0, 157]), np.array([180, 255, 255]))
