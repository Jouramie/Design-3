...
class Color(Enum):
    ...
    BLACK = ((0, 0, 0), np.array([0, 0, 0]), np.array([180, 255, 70]))
    BLUE = ((255, 0, 0), np.array([90, 40, 70]), np.array([130, 255, 255]))
    GREEN = ((0, 255, 0), np.array([40, 80, 80]), np.array([70, 255, 255]))
    RED = ((0, 0, 255), np.array([0, 70, 0]), np.array([20, 231, 200]))
    RED2 = ((0, 0, 254), np.array([172, 70, 0]), np.array([180, 231, 200]))
    TARGET_ZONE_GREEN = ((0, 254, 0), np.array([40, 20, 40]), np.array([76, 255, 255]))
    WHITE = ((255, 255, 255), np.array([40, 0, 148]), np.array([160, 255, 255]))
